...
%% Main
files_folder = 'F:\2021-07-26 Partial Copy\RAW_DATA';
cd 'F:\2021-07-26 Partial Copy\RAW_DATA'
date = '2021-07-26-';
channel_a = 1; % channel numbers for desired channels
channel_b = 3;
num_positions = 120;
num_timepoints = 282; % number of timepoints for one channel at one position
